...
namespace Vital.Web.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IServiceTypeService, ServiceTypeService>(new PerRequestLifetimeManager());
            container.RegisterType<IShipmentRateService, ShipmentRateService>(new PerRequestLifetimeManager());
            container.RegisterType<ITimeInTransitService, TimeInTransitService>(new PerRequestLifetimeManager());
            #endregion
            ...
            container.RegisterType<IRepository<Data.Models.Service>, Repository<Data.Models.Service>>(new PerRequestLifetimeManager());
            container.RegisterType<IRepository<ServiceShipmentRate>, Repository<ServiceShipmentRate>>(new PerRequestLifetimeManager());
            container.RegisterType<IRepository<TimeInTransitCode>, Repository<TimeInTransitCode>>(new PerRequestLifetimeManager());
            #endregion
        }
    }
}
