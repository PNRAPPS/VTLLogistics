...
namespace Vital.Web.Controllers
{
    public class QuantumController : Controller
    {
        ...
        [HttpPost]
        public ActionResult GetShipmentDetails(string eventName, string shipmentNumber, string filter, string tag, string status, string fromDate, string toDate, string dateType)
        {
            try
            {
                List<QuantumViewShipmentDetail> data = _QvService.GetShipmentData(eventName, status, filter, tag, shipmentNumber, fromDate, toDate, dateType).ToList();
        ...
        public ActionResult ExportToExcel(string eventName, string filter, string tag, string fromDate, string toDate, string dateType)
        {
            List<QuantumViewShipmentDetail> data = _QvService.GetShipmentData(eventName, "", filter, tag, "", fromDate, toDate, dateType).ToList();
