...
namespace UPS.Service
{
    ...
    public class QuantumService : IQuantumService
    {
        ...
        public IEnumerable<string> GetOutboundSearchFilters()
        {
            ...
            yield return "Status";
            yield return "Ship To";
            yield return "Ship To Address Line 1";
            yield return "Ship To Address Line 2";
            yield return "Ship To City";
            yield return "Ship To Country";
            yield return "Ship To Attention";
