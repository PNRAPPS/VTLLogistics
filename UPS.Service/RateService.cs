...
namespace UPS.Service
{
    public class RateService : IRateService
    {
        ...
        {
            return GetRate(model, model.ServiceType, string.Empty);
        }

        public RateResponse GetRate(ShipmentModel model, string ServiceCode, string ServiceName)
        {
            ...
            try
            {
                ...
                String[] addressLine = { model.ConsignorAddress1, model.ConsignorAddress2, model.ConsignorAddress3 };
                ...
                String[] addressLine1 = { model.ConsigneeAddress1, model.ConsigneeAddress2, model.ConsigneeAddress3 };
