...
namespace Vital.Data.Models
{
    public partial class VitalContext : DataContext
    {
        ...
        public DbSet<ServiceShipmentRate> ServiceShipmentRate { get; set; }
        public DbSet<TimeInTransitCode> TimeInTransitCode { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new ServiceShipmentRateMap());
            modelBuilder.Configurations.Add(new TimeInTransitCodeMap());
        }
    }
}
